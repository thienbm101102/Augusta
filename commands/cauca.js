...
const lootTable = [
    ...
    { name: 'Mực Biển', multiplier: 1, weight: 25, emoji: '<a:93381squidswims:1418648944795324566>' },
    { name: 'Cá Ngựa', multiplier: 1.5, weight: 20, emoji: '<a:36680seahorse:1418648949132103892>' },
    { name: 'Cá Hồi', multiplier: 2, weight: 15, emoji: '🍣' },
    { name: 'Sứa Biển', multiplier: 2, weight: 10, emoji: '<a:1707jellyfish:1418648953305567447>' },
    { name: 'Cá Nóc', multiplier: 3, weight: 10, emoji: '🐡' },
    { name: 'Ngọc Trai', multiplier: 5, weight: 5, emoji: '<a:95202clamwithpearl:1418648942429732996>' },
    { name: 'Kho Báu Biển Sâu', multiplier: 10, weight: 4, emoji: '<a:treasure_chest:1418648958007246858>' },
